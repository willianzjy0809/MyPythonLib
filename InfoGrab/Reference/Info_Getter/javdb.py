...
import json
from getHtml import get_html_javdb
from getHtml import post_html
...
#        '//strong[text()="演員:"]/../span/strong[@class="symbol female"][last()]/preceding-sibling::a/text()')
    result1 = html.xpath('//strong[text()="演員:"]/following-sibling::span/a/text()')
#    result2 = html.xpath(
#        '//strong[text()="Actors:"]/../span/strong[@class="symbol female"][last()]/preceding-sibling::a/text()')
    result2 = html.xpath('//strong[text()="Actor(s):"]/following-sibling::span/a/text()')
...
'''
print(main('IPX-604', 'https://javdb.com/search?q=IPX-604&f=all'))
# print(main('SSIS-084', ''))
# print(main('abs-141', ''))
# print(main('HYSD-00083', ''))
# print(main('IESP-660', ''))
